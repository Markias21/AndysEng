// 원어민 모범 답안에서 표현을 빈칸으로 뚫는 도메인 로직. 순수 함수만 — UI/저장소를 import하지 않는다.
//
// 모범 답안을 그냥 읽는 것보다 표현을 직접 인출해 볼 때 훨씬 오래 남는다는 연구(빈칸 > 읽기)에 따라,
// AI가 이미 돌려준 native_expressions를 native_answer 안에서 찾아 빈칸으로 바꾼다.
// 표현 목록에는 뜻·예문·레벨이 붙어 있어서, 인출에 실패한 빈칸을 그대로 복습 카드로 만들 수 있다.
